...
def test_batch():
    ...
    for class_name in class_list:
        ...
        gt_basedir = '/media/lqj/00091A6B000C89CB/lqj/Pix2Vox_datasets/Shapenet_unseen/ShapeNetVoxel/' + gt_class_name
        voxel_basedir = '../myShapeNet_render_unseen/' + voxel_class_name
        ...
        mean_iou = []
        for i in range(20,len(class_iou)):
